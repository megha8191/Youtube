...
import { SearchShimmer, VideoPlayShimmer } from './Shimmer';
import './../assets/detailpage.css';


const Videodetail = () => {
    const InitailOpen = useSelector((store)=>store.app.isOpen);
    ...
    if (videoInfo)
     {
        ...
        return (
            <div className='w-100 basis-full max-w-screen-2xl mx-auto'>
                <div className='basis-full grid xl:grid-cols-[1fr,minmax(400px,440px)] lg:grid-cols-[1fr,370px] grid-cols-1 gap-3'>
                    {(videoInfo) ? (
                    <div className=''>
                        <div className='videoInformation'>
                            <iframe
                                ...
                                allowFullScreen
                            ></iframe>
                            <h3 className='font-bold md:text-xl sm:text-lg lg:mt-3 mt-2'>{title}</h3>
                            <div className='grid gap-4 mt-3 sm:grid-cols-[auto,1fr] sm:gap-2 '>
                                ...
                                <div className='videoActions sm:ml-auto flex gap-2 items-center    '>
                                    <div className='bg-gray-100  rounded-full w-auto inline-block'>
                                        <button className='min-w-24 justify-center text-center gap-1 py-2 border-r border-r-gray-200 inline-flex items-center'>
                                        ...
                                        <button className='xl:min-w-12 lg:min-w-11 justify-center text-center gap-1 py-2 inline-flex items-center'>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                        ...
                        <div className='Comments'>
                            <p className="lg:text-xl sm:text-lg font-bold mt-8">{commentCount} Comments</p>
                            {(commentsList) ? (
