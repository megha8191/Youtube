...
const Sidebar = () => {
  ...
  return (
    <div className={(!nav) ? 'basis-auto sidenav lg:min-w-20 sm:min-w-16 min-w-14 ' : ' basis-auto sidebar-open lg:min-w-60 sidenav min-w-16'} id="sidebar">
      <div className='mr-sm-4 mr-3'>
        <ul className='lg:px-3 px-2 sidebar-list overflow-y-auto'>
          <li className='bg-gray-100 font-medium' onClick={() => { navigate("/"); dispatch(updateCat(0)) }}>
            ...
            {(!nav) ? "" : <span className="nav-list-name"> Home</span>}
          </li>
          {/* <li>
            <Link to="/history">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              {(!nav) ? "" : <span className="nav-list-name"> History</span>}
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/live">
              ...
              {(!nav) ? "" : <span className="nav-list-name"> Live</span>}
            </Link>
          </li>
          <hr className='my-4'>
          </hr>
          ...
          <li onClick={() => { navigate("/"); dispatch(updateCat(26)) }}>
            ...
            {(!nav) ? "" : <span className="nav-list-name">Fashion & Beauty</span>}
          </li>
          ...
          <li onClick={() => showHelp()}>
            ...
            {(!nav) ? "" : <span className="nav-list-name"> Help</span>}
          </li> */}
        </ul>
